...
export default function USAPurchaseClient({ session }: { session: Session }) {
  const [step, setStep] = useState<'container' | 'contents'>('container');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-900 to-green-800 text-white p-6">
        ...
        {step === 'contents' && (
          <div className="bg-green-800 p-6 rounded-xl shadow-2xl mb-8 border border-green-700">
            <h2 className="text-2xl font-semibold mb-6 text-center">
              Contents of Container {currentContainer.containerId}
            </h2>
              ...
              <div key={container.id} className="mb-6 p-4 bg-green-700 rounded-lg border border-green-600">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <button
                    ...
                    className="bg-red-600 hover:bg-red-500 text-white px-4 py-1 rounded transition duration-200"
                  >
                    Delete Container
                  </button>
                </div>
